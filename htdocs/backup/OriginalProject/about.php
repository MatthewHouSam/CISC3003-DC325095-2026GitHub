...
<?php require __DIR__ . '/includes/favicon_links.php'; ?>
    ...
    <link rel="stylesheet" href="./assets/public-page.css?v=<?= file_exists(__DIR__ . '/assets/public-page.css') ? filemtime(__DIR__ . '/assets/public-page.css') : time() ?>">
...
<script src="./assets/public_i18n.js?v=<?= file_exists(__DIR__ . '/assets/public_i18n.js') ? filemtime(__DIR__ . '/assets/public_i18n.js') : time() ?>"></script>
