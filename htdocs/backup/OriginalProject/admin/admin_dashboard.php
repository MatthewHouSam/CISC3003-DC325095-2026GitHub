...
<main class="layout">
    ...
    <section class="content-card">
        ...
        <div id="staffSection" class="section">
            ...
            <div class="grid-2">
                <input id="staffCampusID" data-i18n-placeholder="staffCampusPlaceholder" placeholder="staff001">
                <input id="staffFullName" data-i18n-placeholder="staffNamePlaceholder" placeholder="Full Name">
                <input id="staffEmail" type="email" data-i18n-placeholder="staffEmailPlaceholder" placeholder="staff@um.edu.mo">
                <input id="staffPhone" data-i18n-placeholder="staffPhonePlaceholder" placeholder="+853-0000-0000">
                <input id="staffPassword" type="password" data-i18n-placeholder="staffPasswordPlaceholder" placeholder="Password">
...
const I18N = mergeFooterI18n({
  en: {
    ...
    staffCampusPlaceholder: 'staff001',
    staffNamePlaceholder: 'Full Name',
    staffEmailPlaceholder: 'staff@um.edu.mo',
    staffPhonePlaceholder: '+853-0000-0000',
    staffPasswordPlaceholder: 'Password',
  ...
  'zh-CN': {
    ...
    staffCampusPlaceholder: 'staff001',
    staffNamePlaceholder: '姓名',
    staffEmailPlaceholder: 'staff@um.edu.mo',
    staffPhonePlaceholder: '+853-0000-0000',
    staffPasswordPlaceholder: '密码',
    campusIdCol: 'Campus ID',
    emailCol: '邮箱',
...
async function addStaff() {
    ...
    if (!campusID || !fullName || !email || !password) return alert(t('fillStaffRequired'));
