...
<?php require __DIR__ . '/includes/favicon_links.php'; ?>
    ...
    <link rel="stylesheet" href="./assets/dashboard.css?v=<?= file_exists(__DIR__ . '/assets/dashboard.css') ? filemtime(__DIR__ . '/assets/dashboard.css') : time() ?>">
    <link rel="stylesheet" href="./assets/forum.css?v=<?= file_exists(__DIR__ . '/assets/forum.css') ? filemtime(__DIR__ . '/assets/forum.css') : time() ?>">
