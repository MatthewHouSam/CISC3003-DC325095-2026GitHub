...
<?php require __DIR__ . '/includes/favicon_links.php'; ?>
    ...
    <link rel="stylesheet" href="./assets/login.css?v=<?= file_exists(__DIR__ . '/assets/login.css') ? filemtime(__DIR__ . '/assets/login.css') : time() ?>">
    ...
    <div class="auth-split">
        <aside class="auth-aside" style="--auth-aside-img: url('./assets/images/home/feature-campus.jpg');">
            <div class="auth-aside-logo-wrap">
                <img src="./UM Rental.png" alt="UM Rental logo" class="auth-aside-logo" width="640" style="max-width:98%;height:auto;max-height:460px;">
            </div>
